...
if st.sidebar.button("Predict"):
  if classifier == 'Support Vector Machine':
    species_type = prediction(svc_model,island,bill_length_mm,bill_depth_mm,flipper_length_mm,body_mass_g,gender)
    score = svc_model.score(X_train, y_train)

  elif classifier =='Logistic Regression':
    species_type = prediction(log_reg,island,bill_length_mm,bill_depth_mm,flipper_length_mm,body_mass_g,gender)
    score = log_reg.score(X_train, y_train)

  else:
    species_type = prediction(rf_clf,island,bill_length_mm,bill_depth_mm,flipper_length_mm,body_mass_g,gender)
